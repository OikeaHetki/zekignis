...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--Set itself from GY if you fusion summoned "frightfur"
...
function s.cfilter(c,tp)
	return c:IsSetCard(0xad) and c:IsSummonPlayer(tp) and c:IsSummonType(SUMMON_TYPE_FUSION) and c:IsType(TYPE_FUSION)
end
