...
function s.filter(c)
	return c:IsType(TYPE_MONSTER) and c:IsAbleToHand() and not c:IsRace(RACE_DIVINE) and (aux.IsCodeListed(c,CARD_RA) or aux.IsCodeListed(c,10000000) or aux.IsCodeListed(c,10000020))
end
