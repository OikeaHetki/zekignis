...
function s.costfilter(c)
	return c:IsAttribute(ATTRIBUTE_DARK) and c:GetBaseDefense()==0 and not c:IsLinkMonster()
end
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetTarget(aux.TargetBoolFunction(Card.IsDefenseBelow,1500))
	e1:SetValue(0)
	...
	e2:SetTarget(aux.TargetBoolFunction(Card.IsDefenseBelow,1500))
