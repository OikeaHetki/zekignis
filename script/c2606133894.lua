...
--spsum while pandemonium exists
...
function s.descon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(aux.FaceupFilter(Card.IsCode,94585852),tp,LOCATION_ONFIELD,0,1,nil)
		or Duel.IsEnvironment(94585852,tp)
end
...
function s.desop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.IsExistingMatchingCard(aux.FaceupFilter(Card.IsCode,94585852),tp,LOCATION_ONFIELD,0,1,nil)
		or Duel.IsEnvironment(94585852,tp) then
		local g=Duel.GetMatchingGroup(s.filter,tp,0,LOCATION_ONFIELD,nil)
