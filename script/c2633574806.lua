...
--zekpro version (checks both graves, uses HERO monsters)
local s,id=GetID()
...
function s.atkup(e,c)
	return Duel.GetMatchingGroupCount(Card.IsSetCard,c:GetControler(),LOCATION_GRAVE,LOCATION_GRAVE,nil,SET_HERO)*100
end