...
function s.descost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local fg=Duel.GetMatchingGroup(aux.FilterFaceup(Card.IsLevelBelow,#cg),tp,LOCATION_MZONE,LOCATION_MZONE,nil)
...
function s.desop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,aux.FilterFaceup(Card.IsLevel,lv),tp,LOCATION_MZONE,LOCATION_MZONE,1,1,nil)
