...
--Todally Awesome
--zekpro version
--not to be confused with frog the jamally amazin'
local s,id=GetID()
...
function s.cfilter(c)
	return (c:IsLocation(LOCATION_HAND) or c:IsFaceup()) and c:IsAbleToGraveAsCost() and c:IsSetCard(0x12)
end
...
function s.thfilter(c)
	return c:IsAttribute(ATTRIBUTE_WATER) and c:IsRace(RACE_AQUA) and c:IsAbleToHand()
end
