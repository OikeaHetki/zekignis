...
s.listed_names={65984457}
--gain lp on summon
function s.filter(c)
	return c:HasNonZeroDefense() and c:IsSetCard(0x19)
end
...
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return ft>0 and Duel.IsExistingMatchingCard(s.filter2,tp,LOCATION_DECK,0,1,nil,e,tp) end
