...
function s.matcheck(g,lc,sumtype,tp)
	return g:IsExists(Card.IsSetCard,1,nil,0x37,lc,sumtype,tp)
end
---th
...
function s.gyfilter(c)
	return c:IsType(TYPE_MONSTER) and c:IsSetCard(0x37) and c:IsAbleToGrave()
end
