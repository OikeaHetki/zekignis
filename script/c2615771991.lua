...
function s.initial_effect(c)
	...
	--Specifically lists itself and "The Winged Dragon of Ra", Obelisk, and Slifer
s.listed_names={id,CARD_RA,10000000,10000020}
...
function s.thfilter(c)
	return (aux.IsCodeListed(c,CARD_RA) or aux.IsCodeListed(c,10000000) or aux.IsCodeListed(c,10000020)) and c:IsType(TYPE_SPELL+TYPE_TRAP) and c:IsAbleToHand()
end
	--Activation legality
function s.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	--Add 1 spell/trap that specifically lists one of the gods from deck to hand
