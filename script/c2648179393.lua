...
function s.initial_effect(c)
	...
	e4:SetProperty(EFFECT_FLAG_CANNOT_DISABLE+EFFECT_FLAG_CANNOT_NEGATE+EFFECT_FLAG_CANNOT_INACTIVATE+EFFECT_FLAG_NO_TURN_RESET)
	e4:SetCountLimit(1)
...
function s.op(e,tp,eg,ep,ev,re,r,rp)
	e:GetHandler():CopyEffect(2648179391,RESET_EVENT+RESETS_STANDARD)
end
